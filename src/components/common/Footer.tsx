          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-6">
                <a href="https://www.facebook.com/" className="hover:text-red-400 transition text-2xl">📘</a>
                <a href="https://www.instagram.com/" className="hover:text-red-400 transition text-2xl">📸</a>
                <a href="https://github.com/dashboard" className="hover:text-red-400 transition text-2xl">🐙</a>
              </div>
              <p className="text-sm">
