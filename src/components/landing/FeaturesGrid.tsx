...
const features: Feature[] = [
  {
    ...
    gradient: "from-button-primary-DEFAULT to-brand-accent-DEFAULT",
  },
  {
    ...
    gradient: "from-brand-secondary-DEFAULT to-brand-secondary-light",
  },
  {
    title: "Real-Time Analytics",
    desc: "Track campaign performance, engagement metrics, and ROI with comprehensive analytics dashboard.",
    icon: BarChart3,
    color: "text-brand-secondary-light",
    gradient: "from-brand-secondary-DEFAULT to-brand-highlight-DEFAULT",
  },
  {
    title: "In-App Collaboration",
    desc: "Seamless communication with built-in chat, file sharing, and project management tools.",
    icon: MessageSquare,
    color: "text-brand-accent-light",
    gradient: "from-brand-accent-DEFAULT to-brand-accent-dark",
  },
  {
    ...
    gradient: "from-button-primary-DEFAULT to-brand-primary-700",
  },
  {
    title: "Campaign Management",
    desc: "Plan, execute, and monitor multiple campaigns from a single unified dashboard.",
    icon: Target,
    color: "text-brand-accent-DEFAULT",
    gradient: "from-brand-accent-DEFAULT to-brand-highlight-DEFAULT",
  },
  {
    title: "Fast Onboarding",
    desc: "Get started in minutes with our intuitive setup process and helpful onboarding guides.",
    icon: Zap,
    color: "text-brand-highlight-DEFAULT",
    gradient: "from-brand-highlight-DEFAULT to-brand-highlight-light",
  },
  {
    ...
    icon: Award,
    color: "text-brand-secondary-light",
    gradient: "from-brand-secondary-light to-brand-secondary-DEFAULT",
  },
];
